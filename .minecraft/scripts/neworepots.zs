...
// 1
crops.create("gold", <item:minecraft:gold_block>, <blockstate:emendatusenigmatica:gold_ore>, 400, "six");
...
crops.create("uranium", <tag:items:forge:storage_blocks/uranium>, <blockstate:emendatusenigmatica:uranium_ore>, 400, "six");
val uranium = crops.getCrop("uranium");
uranium.addDrop(<item:emendatusenigmatica:uranium_ore>, 1);
uranium.addDrop(<item:emendatusenigmatica:uranium_ingot>, 0.05);
